...
namespace Web.Api.Controllers
{
    ...
    public class StudyFormController : Controller
    {
        ...
        public StudyFormController(IStudyFormService service, IMapper mapper)
        {
            _service = service;
            _mapper = mapper;
        }
        ...
        public IActionResult GetById(int id)
        {
            try
            {
                ...
                return Ok(_mapper.Map<BL.StudyForm, StudyForm>(entity));
            }
            catch (Exception ex)
            {
        ...
        public async Task<IActionResult> GetAll()
        {
            try
            {
                ...
                return Ok(_mapper.Map<ICollection<BL.StudyForm>, ICollection<StudyForm>>(entity));
            }
            catch (Exception ex)
            {
                return BadRequest($"{ex.Message}");
        ...
        [HttpPost]
        public async Task<IActionResult> Post([FromBody]StudyForm value)
        {
            try
            {
