    ...
    public class GroupController : Controller
    {
        ...
        public IActionResult GetById(int id)
        {
            try
            {
                ...
                return Ok(_mapper.Map<BL.Group, Group>(entity));
            }
            catch (Exception ex)
            {
        ...
        public async Task<IActionResult> GetAll()
        {
            try
            {
                ...
                return Ok(_mapper.Map<ICollection<BL.Group>, ICollection<Group>>(entity));
            }
            catch (Exception ex)
            {
                return BadRequest($"{ex.Message}");
        ...
        public async Task<IActionResult> Post([FromBody]Group value)
        {
            try
            {
                var entity = _mapper.Map<BL.Group>(value);
        ...
        [HttpPut]
        public async Task<IActionResult> Put([FromBody]Group value)
        {
            try
            {
                var entity = _mapper.Map<BL.Group>(value);
