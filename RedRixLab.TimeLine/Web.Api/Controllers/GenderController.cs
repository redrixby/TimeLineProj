    ...
    public class GenderController : Controller
    {
        ...
        public IActionResult GetById(int id)
        {
            try
            {
                ...
                return Ok(_mapper.Map<BL.Gender, Gender>(entity));
            }
            catch (Exception ex)
            {
        ...
        [HttpPost]
        public async Task<IActionResult> Post([FromBody]Gender value)
        {
            try
            {
                var entity = _mapper.Map<BL.Gender>(value);
        ...
        [HttpPut]
        public async Task<IActionResult> Put([FromBody]Gender value)
        {
            try
            {
                var entity = _mapper.Map<BL.Gender>(value);
