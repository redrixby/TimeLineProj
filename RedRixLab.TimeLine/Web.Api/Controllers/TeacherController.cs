    ...
    public class TeacherController : Controller
    {
        ...
        public IActionResult GetById(int id)
        {
            try
            {
                ...
                return Ok(_mapper.Map<BL.Teacher, Teacher>(entity));
            }
            catch (Exception ex)
            {
        ...
        public async Task<IActionResult> GetAll()
        {
            try
            {
                ...
                return Ok(_mapper.Map<ICollection<BL.Teacher>, ICollection<Teacher>>(entity));
            }
            catch (Exception ex)
            {
                return BadRequest($"{ex.Message}");
        ...
        public async Task<IActionResult> Post([FromBody]Teacher value)
        {
            try
            {
                var entity = _mapper.Map<BL.Teacher>(value);
        ...
        [HttpPut]
        public async Task<IActionResult> Put([FromBody]Teacher value)
        {
            try
            {
                var entity = _mapper.Map<BL.Teacher>(value);
