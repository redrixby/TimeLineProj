    ...
    public class StudyTypeController : Controller
    {
        ...
        public IActionResult GetById(int id)
        {
            try
            {
                ...
                return Ok(_mapper.Map<BL.StudyType, StudyType>(entity));
            }
            catch (Exception ex)
            {
        ...
        public async Task<IActionResult> GetAll()
        {
            try
            {
                ...
                return Ok(_mapper.Map<ICollection<BL.StudyType>, ICollection<StudyType>>(entity));
            }
            catch (Exception ex)
            {
                return BadRequest($"{ex.Message}");
        ...
        [HttpPost]
        public async Task<IActionResult> Post([FromBody]StudyType value)
        {
            try
            {
