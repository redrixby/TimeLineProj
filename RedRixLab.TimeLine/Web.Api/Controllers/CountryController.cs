    ...
    public class CountryController : Controller
    {
        ...
        public IActionResult GetById(int id)
        {
            try
            {
                ...
                return Ok(_mapper.Map<BL.Country, Country>(entity));
            }
            catch (Exception ex)
            {
        ...
        public async Task<IActionResult> GetAll()
        {
            try
            {
                ...
                return Ok(_mapper.Map<ICollection<BL.Country>, ICollection<Country>>(entity));
            }
            catch (Exception ex)
            {
                return BadRequest($"{ex.Message}");
        ...
        public async Task<IActionResult> Post([FromBody]Country value)
        {
            try
            {
                var entity = _mapper.Map<BL.Country>(value);
        ...
        [HttpPut]
        public async Task<IActionResult> Put([FromBody]Country value)
        {
            try
            {
                var entity = _mapper.Map<BL.Country>(value);
