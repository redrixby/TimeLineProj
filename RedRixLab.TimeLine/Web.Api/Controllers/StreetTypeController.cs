...
namespace Web.Api.Controllers
{
    ...
    public class StreetTypeController : Controller
    {
        ...
        public StreetTypeController(IStreetTypeService service, IMapper mapper)
        {
            _service = service;
            _mapper = mapper;
        }
        ...
        public IActionResult GetById(int id)
        {
            try
            {
                ...
                return Ok(_mapper.Map<BL.StreetType, StreetType>(entity));
            }
            catch (Exception ex)
            {
        ...
        public async Task<IActionResult> GetAll()
        {
            try
            {
                ...
                return Ok(_mapper.Map<ICollection<BL.StreetType>, ICollection<StreetType>>(entity));
            }
            catch (Exception ex)
            {
                return BadRequest($"{ex.Message}");
        ...
        [HttpPost]
        public async Task<IActionResult> Post([FromBody]StreetType value)
        {
            try
            {
