    ...
    public class AddressController : Controller
    {
        ...
        public IActionResult GetById(int id)
        {
            try
            {
                ...
                return Ok(_mapper.Map<BL.Address, Address>(entity));
            }
            catch (Exception ex)
            {
        ...
        public async Task<IActionResult> GetAll()
        {
            try
            {
                ...
                return Ok(_mapper.Map<ICollection<BL.Address>, ICollection<Address>>(entity));
            }
            catch (Exception ex)
            {
                return BadRequest($"{ex.Message}");
        ...
        public async Task<IActionResult> Post([FromBody]Address value)
        {
            try
            {
                var entity = _mapper.Map<BL.Address>(value);
